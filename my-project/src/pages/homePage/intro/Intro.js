                ...
                <div className="panel-home">
                    <div className="left-home">
                        ...
                        <div className="buttons-home">
                            <ButtonSimple height="40px" text={texts.TextButtonCurriculum_Intro} width="150px" borderRadius="12px" href="https://drive.google.com/file/d/1JXpuj5mTrfJXeduUrO-5VELts9QWvYFr/view?usp=sharing" target="_blank" rel="noopener noreferrer" alt="Botão de Curriculo" />
